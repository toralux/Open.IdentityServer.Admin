...
[![License](https://img.shields.io/badge/License-Apache%202.0-blue?style=for-the-badge)](https://github.com/skoruba/Duende.IdentityServer.Admin/blob/main/LICENSE)
...
> [changelog](https://github.com/skoruba/Duende.IdentityServer.Admin/blob/main/CHANGELOG.md) for the full list of changes.
...
| 🛡️  | **Security**          | Hardened audit logging, stronger validation      |
...
For detailed release history and upcoming features, see [CHANGELOG.md](https://github.com/skoruba/Duende.IdentityServer.Admin/blob/main/CHANGELOG.md).
