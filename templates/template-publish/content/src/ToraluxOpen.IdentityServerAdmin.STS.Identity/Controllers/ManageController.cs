...
using ToraluxOpen.IdentityServerAdmin.STS.Identity.ViewModels.Manage;

namespace ToraluxOpen.IdentityServerAdmin.STS.Identity.Controllers
{    
    [Authorize]
        ...
        where TKey : IEquatable<TKey>
    {
        ...
        private string GenerateQrCodeUri(string email, string unformattedKey)
        {
            return string.Format(
                ...
                _urlEncoder.Encode("ToraluxOpen.IdentityServerAdmin.STS.Identity"),
