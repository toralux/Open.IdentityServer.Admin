...
namespace Toralux.Open.IdentityServer.Admin.BusinessLogic.ConfigurationRules.ClientRules;

public class ClientIdMustStartWithRule : ConfigurationRuleValidatorBase, IConfigurationRuleValidator
{
        ...
        foreach (var client in clients)
        {
            ...
            if (!startsWithAnyPrefix)
            {
                var parameters = new Dictionary<string, string>
                {
                    ...
                    ["actualClientId"] = client.ClientId
                };
