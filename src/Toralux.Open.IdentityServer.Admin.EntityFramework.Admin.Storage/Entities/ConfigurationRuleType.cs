...
namespace Toralux.Open.IdentityServer.Admin.EntityFramework.Admin.Storage.Entities;
...
public enum ConfigurationRuleType
{
    ...
    ClientSigningAlgorithmsMustBeFapiCompliant,
    ApiResourceSigningAlgorithmsMustBeFapiCompliant
}
